...
exports.writeAIDecisionToFirestore = void 0;
const admin = __importStar(require("firebase-admin"));
// Initialize Firestore using the admin SDK
const db = admin.firestore();
const writeAIDecisionToFirestore = (disputeId, aiSummary, aiDecision) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.writeAIDecisionToFirestore = writeAIDecisionToFirestore;
//# sourceMappingURL=writeAIDecisionToFirestore.js.map